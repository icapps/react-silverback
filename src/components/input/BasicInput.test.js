...
describe('BasicInput Component', () => {
  ...
  it('should render a BasicInput component with a placeholder', () => {
    const wrapper = shallow(
      <BasicInput id="test" label="Text with placeholder" placeholder="placeholder" value="" handleChange={() => {}} />,
    );
    expect(wrapper).toMatchSnapshot();
  });
  ...
  it('should render a BasicInput component with a type of password', () => {
    const wrapper = shallow(
      <BasicInput id="test" label="Password" value="password" handleChange={() => {}} type="password" />,
    );
    expect(wrapper).toMatchSnapshot();
  });
