    ...
    return new Promise(async resolve => {
      ...
      if (result.action && result.action.type === constants.CREATE_LANGUAGE_CODE_FULFILLED) {
        this.props.history.push(
          `${window.location.pathname}/${this.props.languageCode.id}`,
          this.props.languageCode.id,
        );
      ...
      <Overview
        ...
        keys={[
          ...
          { id: identifiers.NAME, value: strings.NAME, isSortable: true, sorter: identifiers.NAME, width: 4 },
          {
            ...
            value: strings.DEPRECATED,
            isSortable: true,
            sorter: identifiers.DEPRECATED,
            width: 2,
          },
        ]}
        listItems={this.props.languageCodes.map(languageCode => {
          return { ...languageCode, deprecated: !!languageCode.deprecated, active: !languageCode.deprecated };
        })}
